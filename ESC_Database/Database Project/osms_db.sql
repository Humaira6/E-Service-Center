...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2022 at 04:10 PM
...
(1, 'Admin1', 'admin@gmail.com', '123456');
...
(1, 'Ram', '2022-03-01', 1, 2, 600, 700),
(2, 'Keyboard', '2022-03-03', 3, 3, 600, 700),
(3, 'Mouse', '2022-03-03', 2, 3, 400, 500),
(4, 'USB', '2022-03-16', 3, 5, 100, 150);
...
CREATE TABLE `technician_tb` (
  ...
  `empPass` varchar(255) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
