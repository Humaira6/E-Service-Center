...
if(isset($_REQUEST['empsubmit'])){
 ...
 if(($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")||($_REQUEST['empPass'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $sql = "INSERT INTO technician_tb (empName, empCity, empMobile, empEmail,empPass) VALUES ('$eName', '$eCity','$eMobile', '$eEmail','$ePass')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="empPass">Temporay Password</label>
