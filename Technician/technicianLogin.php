...
if(!isset($_SESSION['is_techlogin'])){
  if(isset($_REQUEST['temail'])){
    ...
    $sql = "SELECT empEmail, empPass FROM technician_tb WHERE empEmail='".$temail."' AND empPass='".$tpassword."' limit 1";
...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <span>E-Service Center</span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>Technician
      Area</span>
  </p>
